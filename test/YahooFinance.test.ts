...
import { Interval, SearchResultItem } from "../src/store.js";
import { Exchange } from "../src/exchange.js";
import { Currency } from "../src/money.js";
...
describe("YahooFinance", () => {
    ...
    test("historical exchange rate EUR to USD on December 3 2018", async () => {
        ...
        expect(rate.rate).toBe(1.134224);
    });
    ...
    test("AAPL total stock split mulitplier between December 12 1980 and September 2 2020", async () => {
